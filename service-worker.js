const CACHE_NAME = "class-hub-v81";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./app-overrides.css?v=81", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=81", "./admin-document-print.css?v=81", "./admin-document-editor.css?v=81", "./admin-document-layout.css?v=81", "./admin-document-source.css?v=81", "./admin-document-widths.css?v=81", "./admin-document-headings.css?v=81", "./admin-document-exam.css?v=81", "./admin-document-subjects.css?v=81", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./lottery-draw.css", "./app.js?v=81", "./admin.js?v=81", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
