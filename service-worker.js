const CACHE_NAME = "class-hub-v72";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./app-overrides.css?v=72", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=72", "./admin-document-print.css?v=72", "./admin-document-editor.css?v=72", "./admin-document-layout.css?v=72", "./admin-document-source.css?v=72", "./admin-document-widths.css?v=72", "./admin-document-headings.css?v=72", "./admin-document-exam.css?v=72", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./lottery-draw.css", "./app.js?v=72", "./admin.js?v=72", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
