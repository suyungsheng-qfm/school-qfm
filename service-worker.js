const CACHE_NAME = "class-hub-v82";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./app-overrides.css?v=82", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=82", "./admin-document-print.css?v=82", "./admin-document-editor.css?v=82", "./admin-document-layout.css?v=82", "./admin-document-source.css?v=82", "./admin-document-widths.css?v=82", "./admin-document-headings.css?v=82", "./admin-document-exam.css?v=82", "./admin-document-subjects.css?v=82", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./lottery-draw.css", "./app.js?v=82", "./admin.js?v=82", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
