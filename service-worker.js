const CACHE_NAME = "class-hub-v90";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./class-timetable.css?v=90", "./app-overrides.css?v=90", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=90", "./admin-document-print.css?v=90", "./admin-document-editor.css?v=90", "./admin-document-layout.css?v=90", "./admin-document-source.css?v=90", "./admin-document-widths.css?v=90", "./admin-document-headings.css?v=90", "./admin-document-exam.css?v=90", "./admin-document-subjects.css?v=90", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./personal-calendar.css?v=90", "./lottery-draw.css", "./app.js?v=90", "./admin.js?v=90", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
