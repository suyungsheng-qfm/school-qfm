const CACHE_NAME = "class-hub-v5";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./styles.css", "./app-overrides.css", "./login-overrides.css", "./app.js", "./admin.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
