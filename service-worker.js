const CACHE_NAME = "class-hub-v70";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./app-overrides.css?v=70", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=70", "./admin-document-print.css?v=70", "./admin-document-editor.css?v=70", "./admin-document-layout.css?v=70", "./admin-document-source.css?v=70", "./admin-document-widths.css?v=70", "./admin-document-headings.css?v=70", "./admin-document-exam.css?v=70", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./lottery-draw.css", "./app.js?v=70", "./admin.js?v=70", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
