const CACHE_NAME = "class-hub-v69";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./app-overrides.css?v=69", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=69", "./admin-document-print.css?v=69", "./admin-document-editor.css?v=69", "./admin-document-layout.css?v=69", "./admin-document-source.css?v=69", "./admin-document-widths.css?v=69", "./admin-document-headings.css?v=69", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./lottery-draw.css", "./app.js?v=69", "./admin.js?v=69", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
