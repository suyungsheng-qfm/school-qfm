const CACHE_NAME = "class-hub-v77";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./app-overrides.css?v=77", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=77", "./admin-document-print.css?v=77", "./admin-document-editor.css?v=77", "./admin-document-layout.css?v=77", "./admin-document-source.css?v=77", "./admin-document-widths.css?v=77", "./admin-document-headings.css?v=77", "./admin-document-exam.css?v=77", "./admin-document-subjects.css?v=77", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./lottery-draw.css", "./app.js?v=77", "./admin.js?v=77", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
