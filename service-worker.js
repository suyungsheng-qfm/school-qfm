const CACHE_NAME = "class-hub-v83";
const APP_FILES = ["./", "./login.html", "./index.html", "./admin.html", "./lottery-draw.html", "./styles.css", "./app-overrides.css?v=83", "./login-overrides.css", "./admin-overrides.css", "./admin-pages.css", "./school-import.css", "./admin-calendar-view.css", "./admin-account-nav.css", "./admin-documents.css?v=83", "./admin-document-print.css?v=83", "./admin-document-editor.css?v=83", "./admin-document-layout.css?v=83", "./admin-document-source.css?v=83", "./admin-document-widths.css?v=83", "./admin-document-headings.css?v=83", "./admin-document-exam.css?v=83", "./admin-document-subjects.css?v=83", "./calendar-overrides.css", "./calendar-nav.css", "./school-calendar.css", "./lottery-draw.css", "./app.js?v=83", "./admin.js?v=83", "./lottery-draw.js", "./login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./assets/11508.jpeg"];
