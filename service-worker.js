const CACHE_NAME = "class-hub-v2";
const APP_FILES = ["./", "./index.html", "./admin.html", "./teacher-login.html", "./styles.css", "./app-overrides.css", "./app.js", "./admin.js", "./teacher-login.js", "./firebase.js", "./firebase-config.js", "./manifest.webmanifest", "./icon.svg"];
